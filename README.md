...
* **Assignment#2** [Join demographic data](): You may need to preview the [Joining data with dplyr in R](https://www.datacamp.com/courses/joining-data-with-dplyr-in-r) to know how to join two tables according to a variable as key.
