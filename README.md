...
* **Assignment#2** [AS02_dplyr_ptt_result.html](AS02_dplyr_ptt_result.html): Following the assignment to detect questionable users or just big fans of the Kaohsiung Mayor Han. Answer the question directly in the AS#2 markdown file [AS02_prac01_dplyr_ptt_blank.Rmd](AS02_prac01_dplyr_ptt_blank.Rmd) in the repo. 
